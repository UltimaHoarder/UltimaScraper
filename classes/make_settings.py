...
class config(object):
    def __init__(self, info:dict[str,Any]={}, settings:dict[str,Any]={}, supported:dict[str,Any]={}):
        class Info(object):
        ...
        def update_site_settings(options:dict[str,Any]):
        ...
        class SiteSettings:
            def __init__(self, option:dict[str,Any]={}):
                ...
                self.auto_model_choice: list[int|str]|int|str|bool = option.get("auto_model_choice", False)
                self.auto_media_choice : list[int|str]|int|str|bool= option.get("auto_media_choice", "")
        ...
        class Supported(object):
            def __init__(self, onlyfans:dict[str,Any]={}, fansly:dict[str,Any]={}, patreon:dict[str,Any]={}, starsavn:dict[str,Any]={}):
