...
async def example(auth_id:int=0):
    ...
    signed_headers = authed.session_manager.create_signed_headers(link,time_=1640531264796)
    static_1, _, static_2, static_3 = signed_headers["sign"].split(":")
    assert f"{static_1}:5f31297d3b4d02e2e278a943bdce703389cf90a4:{static_2}:{static_3}" ==  signed_headers["sign"]
