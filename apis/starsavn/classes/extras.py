...
class endpoint_links(object):
    def __init__(
        ...
        self.customer = f"https://{domain}/api2/v2/users/me"
        self.users = f"https://{domain}/api2/v2/users/{identifier}"
        self.subscriptions = f"https://{domain}/api2/v2/subscriptions/following?limit={global_limit}&offset={global_offset}&type=active"
